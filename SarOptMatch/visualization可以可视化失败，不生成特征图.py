...
#******************************************************************************        
    ...
    def save(self):
        ...
        if not self.heatmaps is None:
            ...
            draw.rectangle([col_pred, row_pred, col_pred + 2, row_pred + 2], fill=(255, 0, 255), outline=(0, 0, 0))
    ...
    def set_image(self):
        ...
        if not self.heatmaps is None:
            ...
            # Draw predicted match using a rectangle
            draw.rectangle((col_pred * 2, row_pred * 2, (col_pred + 2) * 2, (row_pred + 2) * 2), fill=(255, 0, 255),
                           outline=(0, 0, 0))
